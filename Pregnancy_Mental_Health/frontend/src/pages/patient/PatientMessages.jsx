...
const getTypeConfig = (theme) => ({
  ...
  system: { icon: <Settings size={16} />, color: theme.textMuted, bg: theme.border, label: "System" },
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: theme.pageBg, fontFamily: theme.fontBody }}>
      ...
      <main style={{
        ...
        {/* ── READ ONLY NOTICE ── */}
        <Card style={{ background: theme.primaryBg, border: `1px solid ${theme.primary}20`, display: "flex", gap: 16, alignItems: "center", marginBottom: 32 }}>
          <div style={{ width: 40, height: 40, borderRadius: "50%", background: theme.cardBg, border: `1px solid ${theme.border}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, boxShadow: "0 2px 8px rgba(0,0,0,0.05)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "350px 1fr", gap: 24, height: "calc(100vh - 280px)" }}>
          ...
          {/* ── LEFT: MESSAGE LIST ── */}
          <Card style={{ padding: 0, overflowY: "auto", background: theme.cardBg }}>
            {messages.length === 0 ? (
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      borderLeft: `4px solid ${isSelected ? theme.primary : (msg.read ? "transparent" : theme.border)}`,
                      transition: "all 0.2s"
                    }}
                  >
          ...
          <Card style={{ padding: 0, display: "flex", flexDirection: "column", background: theme.cardBg }}>
            {!selectedMsg ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
                <div style={{ padding: "32px 40px", borderBottom: `1px solid ${theme.border}` }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
                    <div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        <div style={{ width: 32, height: 32, borderRadius: "50%", background: theme.innerBg, display: "flex", alignItems: "center", justifyContent: "center", color: theme.primary }}>
                          <User size={18} />
                        </div>
                        <div>
                ...
                <div style={{ padding: "24px 40px", borderTop: `1px solid ${theme.border}`, background: theme.innerBg, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
