  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", background: theme.pageBg, fontFamily: theme.fontBody }}>
      ...
      <main className="portal-main" style={{ background: theme.pageBg }}>
        ...
        <div className="stats-grid-2" style={{ marginBottom: 32 }}>
          {/* My Doctor */}
          <Card>
        ...
        {/* Journey Card (Empty state or removed) */}
        <Card style={{ marginBottom: 32 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}>
            <h3 style={{ fontSize: 18, fontWeight: 700, color: theme.textPrimary, margin: 0 }}>My Wellness Journey</h3>
            <Badge type="info">Active Support</Badge>
          </div>
          <div style={{ height: 100, display: "flex", alignItems: "center", justifyContent: "center", color: theme.textMuted, fontSize: 14 }}>
            Your care team is monitoring your progress and will update your care plan as needed.
          </div>
        </Card>
