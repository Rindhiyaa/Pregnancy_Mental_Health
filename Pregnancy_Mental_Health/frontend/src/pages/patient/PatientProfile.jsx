...
export default function PatientProfile() { 
  ...
  const Field = ({ label, name, type = "text", options, IconComp, disabled, half }) => ( 
    <div style={{ ...S.fieldWrap, ...(half ? { gridColumn: "span 1" } : {}) }}> 
      <label style={S.fieldLabel}> 
        {IconComp && ( 
          <span style={S.fieldLabelIcon}> 
            <IconComp /> 
          </span> 
        )} 
        {label} 
      ...
      {options ? ( 
        <select 
          ...
          style={{ ...S.input, ...(!editing || disabled ? S.inputOff : S.inputOn) }} 
        > 
  ...
  const PregCard = ({ label, value }) => ( 
    <div style={S.pregCard}> 
      <div style={S.pregCardLabel}>{label}</div> 
      <div style={S.pregCardValue}>{value || "—"}</div> 
    </div> 
  ); 
    ...
    <div style={S.portal}> 
      ...
      <main style={S.main}> 
        ...
        <div style={S.avatarCard}> 
          ...
          <div style={S.avatarStats}> 
            <div style={S.avatarStat}> 
              <div style={S.avatarStatVal}> 
                {form.currentWeek || "—"} 
              </div> 
              <div style={S.avatarStatLabel}>Current Week</div> 
            </div> 
            <div style={S.avatarStatDivider} /> 
            <div style={S.avatarStat}> 
              <div style={S.avatarStatVal}> 
                {form.bloodGroup || "—"} 
              </div> 
              <div style={S.avatarStatLabel}>Blood Group</div> 
            </div> 
            <div style={S.avatarStatDivider} /> 
            <div style={S.avatarStat}> 
              <div style={S.avatarStatVal}> 
              ...
              <div style={S.avatarStatLabel}>Age</div> 
            </div> 
            <div style={S.avatarStatDivider} /> 
            <div style={S.avatarStat}> 
              <div style={S.avatarStatVal}> 
              ...
              <div style={S.avatarStatLabel}>Doctor</div> 
            </div> 
          </div> 
        </div> 
        ...
        ════════════════════════════ */} 
        <Section title="Personal Information" IconComp={Icon.User}> 
          <div style={S.grid2}> 
        ...
        {/* ════════════════════════════ 
            SECTION 3 — PREGNANCY 
        ════════════════════════════ */} 
        <Section title="Pregnancy Details" IconComp={Icon.Heart}> 
 
          {/* Stat row */} 
          <div style={S.pregCards}> 
        ...
        {/* ════════════════════════════ 
            SECTION 4 — ACCOUNT 
        ════════════════════════════ */} 
        <Section title="Account & Security" IconComp={Icon.Lock}> 
          <div style={S.grid2}> 
            <div style={S.infoBlock}> 
              <div style={S.infoBlockLabel}>Member Since</div> 
              <div style={S.infoBlockVal}>19 March 2026</div> 
            </div> 
            <div style={S.infoBlock}> 
              <div style={S.infoBlockLabel}>Account Type</div> 
              <div style={S.roleBadge}>Patient</div> 
            </div> 
          </div> 
          <button 
 ...
 function Section({ title, IconComp, note, accent, children }) { 
   return ( 
     <div style={{ 
       ...S.section, 
 ...
 const S = { 
   ...
   pageSubtitle: { fontSize: 15, color: "#9CA3AF", margin: 0 }, 
   divider: { 
   ...
   avatarEmail: { fontSize: 14, color: "#9CA3AF", marginBottom: 8 }, 
   avatarWeekBadge: { 
   ...
   avatarStat: { textAlign: "center", padding: "0 24px" }, 
   avatarStatVal: { 
     fontFamily: THEME.fontHeading, 
     fontSize: 18, fontWeight: 800, 
     color: "#111827", marginBottom: 4, 
   }, 
   avatarStatLabel: { fontSize: 11, color: "#9CA3AF", fontWeight: 600, letterSpacing: "0.5px" }, 
   avatarStatDivider: { 
     width: 1, height: 36, 
   ...
   pregCardLabel: { 
     ...
     color: "#9CA3AF", letterSpacing: "0.8px", 
   ...
   infoBlockLabel: { fontSize: 13, color: "#9CA3AF", marginBottom: 5 }, 
   infoBlockVal: { 
