...
const Icon = {
  ...
  Phone: () => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
      ...
      <path d="M22 16.92v3a2 2 0 0 1-2.18 2
               ...
               19.5 19.5 0 0 1-6.5-6.95
               19.79 19.79 0 0 1-3.07-8.6A2 2 0 0 1 3.6 1.1h3
               a2 2 0 0 1 2 1.72c.13.96.36 1.9.7 2.81
               a2 2 0 0 1-.45 2.11L7.91 8.74
               a16 16 0 0 0 6.29 6.29l.95-.95
  ...
  Heart: () => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
      ...
      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67
               10.94 4.61a5.5 5.5 0 0 0-7.78 7.78L4.22 13.45
               12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
    </svg>
  ),
  Doctor: () => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
         stroke="currentColor" strokeWidth="2">
      <path d="M3 9a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v9
  ...
  Key: () => (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
         stroke="currentColor" strokeWidth="2">
      <path d="m21 2-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778
               5.5 5.5 0 0 1 7.777-7.777zm0 0L15.5 7.5
               m0 0 3 3L22 7l-3-3m-3.5 3.5L19 4" />
    </svg>
  ),
};
    ...
    <div style={{ ...S.fieldWrap(theme), ...(half ? { gridColumn: "span 1" } : {}) }}>
      ...
      {options ? (
        <select
          ...
          style={{
            ...S.input(theme),
            ...(!editing || disabled ? S.inputOff(theme) : S.inputOn(theme)),
          }}
        >
...
function PregCard({ label, value, theme }) {
  return (
      ...
      <main className="portal-main" style={{ background: theme.pageBg }}>
        ...
        <div style={S.avatarCard(theme)}>
          <div style={S.avatarLeft(theme)}>
            ...
            <div style={S.avatarInfo(theme)}>
              <div style={S.avatarName(theme)}>{form.fullName || "—"}</div>
          ...
          <div style={S.avatarStats(theme)}>
            <div style={S.avatarStat(theme)}>
              <div style={S.avatarStatVal(theme)}>{form.currentWeek || "—"}</div>
              <div style={S.avatarStatLabel(theme)}>Current Week</div>
            </div>
            <div style={S.avatarStatDivider(theme)} />
            <div style={S.avatarStat(theme)}>
              <div style={S.avatarStatVal(theme)}>{form.bloodGroup || "—"}</div>
              <div style={S.avatarStatLabel(theme)}>Blood Group</div>
            </div>
            <div style={S.avatarStatDivider(theme)} />
            <div style={S.avatarStat(theme)}>
              <div style={S.avatarStatVal(theme)}>{form.age || "—"}</div>
              <div style={S.avatarStatLabel(theme)}>Age</div>
            </div>
            <div style={S.avatarStatDivider(theme)} />
            <div style={S.avatarStat(theme)}>
              <div style={S.avatarStatVal(theme)}>{form.doctorName || "—"}</div>
        ...
        <Section title="Pregnancy Details" IconComp={Icon.Heart} theme={theme}>
          <div style={S.pregCards(theme)}>
            <PregCard
              label="Current Week"
              value={form.currentWeek ? `Week ${form.currentWeek}` : ""}
              theme={theme}
            />
            <PregCard label="Doctor" value={form.doctorName} theme={theme} />
            <PregCard label="Hospital" value={form.hospitalName} theme={theme} />
          </div>
        ...
        <Section title="Account & Security" IconComp={Icon.Lock} theme={theme}>
          <div style={S.grid2(theme)}>
            <div style={S.infoBlock(theme)}>
              ...
              <div style={S.infoBlockVal(theme)}>—</div>
            </div>
            <div style={S.infoBlock(theme)}>
