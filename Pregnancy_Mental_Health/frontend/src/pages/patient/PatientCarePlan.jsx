            ...
            <Card>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {plan?.action_steps?.map((step, i) => (
                  <div key={i} style={{ display: "flex", gap: 16, alignItems: "flex-start", padding: "16px", background: THEME.pageBg, borderRadius: 12, border: `1px solid ${THEME.divider}` }}>
            ...
            <Card>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                {plan?.followups?.map((f) => (
                  <div key={f.id} style={{ padding: "16px", borderRadius: 12, border: `1px solid ${THEME.divider}`, background: f.status === 'completed' ? THEME.pageBg : "white", opacity: f.status === 'completed' ? 0.7 : 1 }}>
