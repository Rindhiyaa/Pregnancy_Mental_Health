...
const MOODS = [ 
  ...
  { score: 2, icon: <Frown size={28} />, label: "Sad",       color: "#F97316", bg: "#FFF7ED" }, 
  { score: 3, icon: <Meh size={28} />,   label: "Neutral",   color: THEME.textMuted, bg: THEME.divider }, 
  { score: 4, icon: <Smile size={28} />, label: "Good",      color: THEME.primaryLight, bg: THEME.primaryBg }, 
  { score: 5, icon: <Smile size={28} />, label: "Great",     color: THEME.primary, bg: THEME.sidebarActiveBg }, 
]; 
            ...
            <Card> 
              ...
              {!saved ? ( 
                <> 
                    ...
                    {MOODS.map(m => ( 
                      <button 
                        ...
                        style={{ 
                          ...
                          borderRadius: 12, border: `2px solid ${selected === m.score ? m.color : THEME.divider}`, 
                          background: selected === m.score ? m.bg : "transparent", cursor: "pointer", transition: "all 0.2s" 
                        }} 
                  ...
                  <textarea 
                    style={{ 
                      width: "100%", padding: "14px", borderRadius: 12, border: `1px solid ${THEME.divider}`, 
                ...
                <div style={{ textAlign: "center", padding: "20px 0" }}> 
                  ...
                  <Card style={{ background: THEME.primaryBg, border: "none", marginBottom: 24 }}> 
                    <p style={{ fontSize: 13, color: THEME.primaryText, fontStyle: "italic", margin: 0 }}> 
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}> 
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}> 
              <Card> 
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}> 
                  ...
                  <Badge type="info">{avgMood?.label}</Badge> 
                </div> 
              </Card> 
              <Card> 
            ...
            <Card> 
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24 }}> 
                ...
                <Badge type="primary">Last 14 Days</Badge> 
              </div> 
